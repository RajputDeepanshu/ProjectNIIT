...
<thead><h1><b>UPDATE CATEGORY HERE</b></h1></thead>

<tr>
<td>Category-Id</td>
<td><input type="text" name="id" placeholder="category-Id" required></td>
</tr>
...
<td><textarea row="10" cols="50" name="description" required></textarea></td>
</tr>
